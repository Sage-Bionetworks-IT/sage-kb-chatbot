...
- [ ] 1. Set up project structure, data models, and shared utilities
  ...
  - [ ] 1.3 Implement input sanitization utilities
  ...
  - [ ]* 1.4 Write property tests for input sanitization
  ...
  - [ ] 1.5 Implement answer formatting utility
  ...
  - [ ]* 1.6 Write property tests for answer formatting
...
- [ ] 2. Implement structured logging and audit trail
  ...
  - [ ]* 2.2 Write property test for audit log structure
  ...
  - [ ]* 2.3 Write property test for no secrets in log output
...
- [ ] 3. Implement rate limiter
  - [ ] 3.1 Implement RateLimiter with sliding window counters
  ...
  - [ ]* 3.2 Write property tests for rate limiter
...
- [ ] 5. Implement Rovo MCP backend
  ...
  - [ ]* 5.2 Write property test for Rovo MCP response parsing
  ...
  - [ ]* 5.3 Write unit tests for RovoMCPBackend
    - Test error handling: auth failure returns BackendResult with success=False
    - Test error handling: timeout returns BackendResult with success=False
    - Test health_check returns boolean
    - _Requirements: 7.3, 7.4_

- [ ] 6. Implement Vertex AI Search backend
  - [ ] 6.1 Implement VertexAISearchBackend
  ...
  - [ ]* 6.2 Write property test for Vertex AI Search response parsing
  ...
  - [ ]* 6.3 Write unit tests for VertexAISearchBackend
    - Test error handling: API error returns BackendResult with success=False
    - Test health_check returns boolean
    - _Requirements: 8.3_

- [ ] 7. Implement Bedrock Agent orchestrator
  - [ ] 7.1 Implement BedrockAgentOrchestrator
  ...
  - [ ] 7.2 Implement session ID derivation
  ...
  - [ ]* 7.3 Write property tests for orchestrator
    ...
    - **Validates: Requirements 5.3, 5.5, 5.7, 6.1, 6.2, 6.3**

  - [ ]* 7.4 Write unit tests for orchestrator error handling
    - Test agent failure before tool calls returns error message
    - Test agent failure after successful tool calls returns fallback with raw outputs
    - Test timeout enforcement
    - _Requirements: 5.4, 5.6, 10.6, 10.7_

- [ ] 8. Checkpoint - Ensure all tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Implement Slack Socket Mode application
  - [ ] 9.1 Implement SlackAgentApp with event handlers
  ...
  - [ ] 9.2 Implement event deduplication
  ...
  - [ ]* 9.3 Write property tests for event deduplication and mention stripping
  ...
  - [ ] 9.4 Implement authorization check
  ...
  - [ ] 9.5 Implement progressive UX feedback
  ...
  - [ ] 9.6 Wire rate limiting, orchestrator, formatting, and error handling into event handlers
  ...
  - [ ]* 9.7 Write unit tests for SlackAgentApp
    - Test event parsing for app_mention, DM, and slash command
    - Test empty question rejection with ephemeral message
    - Test unauthorized user receives ephemeral rejection
    - Test rate-limited user receives ephemeral message
    - _Requirements: 1.1, 1.2, 1.3, 2.2, 3.7, 10.5_

- [ ] 10. Implement health check server
  - [ ] 10.1 Implement HealthCheck HTTP server
  ...
  - [ ]* 10.2 Write unit tests for HealthCheck
...
- [ ] 13. Implement CDK infrastructure stack
  - [ ] 13.1 Create CDK app and stack
  ...
  - [ ] 13.2 Configure IAM, secrets, and logging
